        ...
        if (msg.includes('User already registered')) {
          try {
            ...
            if (String(maybeCode) === '23514' || maybeMsg.includes('profiles_role_check')) {
              // Tell the owner exactly which SQL migHandicraft to run
              alert([
                'Failed to create delivery profile because your database is blocking the "delivery" role.',
                '',
                'To fix this, run the following SQL migHandicrafts in your Supabase project SQL editor (in this repo):',
                " - supabase/migHandicrafts/20251014_allow_delivery_role.sql",
                " - supabase/migHandicrafts/20251014_create_profile_rpc.sql",
                '',
